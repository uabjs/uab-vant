...
Vant 是一个**轻量、可定制的移动端组件库**，于 2023 年开源。
...
- 🍭 支持 Nuxt 2、Nuxt 3，提供 Nuxt 的 [Vant Module](https://github.com/uabjs/uab-vant-nuxt)
- 🍭 支持主题定制，内置 700+ 个主题变量
...
| 项目 | 描述 |
| --- | --- |
| [vant-weapp](https://github.com/uabjs/uab-vant-weapp) | Vant 微信小程序版 |
| [vant-demo](https://github.com/uabjs/uab-vant-demo) | Vant 官方示例合集 |
| [vant-cli](https://github.com/uabjs/uab-vant/tree/main/packages/vant-cli) | 开箱即用的组件库搭建工具 |
| [vant-icons](https://github.com/uabjs/uab-vant/tree/main/packages/vant-icons) | Vant 图标库 |
| [vant-touch-emulator](https://github.com/uabjs/uab-vant/tree/main/packages/vant-touch-emulator) | 在桌面端使用 Vant 的辅助库 |
| [vant-nuxt](https://github.com/uabjs/uab-vant-nuxt) | 为 Nuxt 准备的模块 |
...
- [意见反馈](https://github.com/uabjs/uab-vant/issues)
...
使用过程中发现任何问题都可以提 [Issue](https://github.com/uabjs/uab-vant/issues) 给我们，当然，我们也非常欢迎你给我们发 [PR](https://github.com/uabjs/uab-vant/pulls)。
