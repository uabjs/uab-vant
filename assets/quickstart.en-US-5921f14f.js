import{o as n,a,z as t}from"./vue-libs-cca96e89.js";const e={class:"van-doc-markdown-body"},l=t(`<h1>Quickstart</h1><h2 id="install" tabindex="-1">Install</h2><div class="van-doc-card"><h3 id="npm" tabindex="-1">npm</h3><p>Using <code>npm</code> to install:</p><pre><code class="language-bash"><span class="hljs-comment"># install latest Vant for Vue 3 project</span>
npm i @uab/vant
...
<span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
</code></pre></div>`,10),p=[l],h={__name:"quickstart.en-US",setup(o,{expose:s}){return s({frontmatter:{}}),(i,r)=>(n(),a("div",e,p))}};export{h as default};
